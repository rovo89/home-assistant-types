 ...
 * }
 */
export declare const computeLocalize: <Keys extends string = LocalizeKeys>(cache: any, language: string, resources: Resources, formats?: FormatsType) => Promise<LocalizeFunc<Keys>>;
export {};

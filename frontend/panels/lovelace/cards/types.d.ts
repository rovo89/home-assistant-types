...
import { EntityConfig, EntityFilterEntityConfig, LovelaceRowConfig } from "../entity-rows/types";
...
export interface EnergySelfSufficiencyGaugeCardConfig extends LovelaceCardConfig {

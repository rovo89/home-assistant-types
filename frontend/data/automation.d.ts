...
export type Trigger = StateTrigger | MqttTrigger | GeoLocationTrigger | HassTrigger | NumericStateTrigger | SunTrigger | ConversationTrigger | TimePatternTrigger | WebhookTrigger | PersistentNotificationTrigger | ZoneTrigger | TagTrigger | TimeTrigger | TemplateTrigger | EventTrigger | DeviceTrigger | CalendarTrigger;
...
export declare const saveAutomationConfig: (hass: HomeAssistant, id: string, config: AutomationConfig) => Promise<void>;
export declare const showAutomationEditor: (data?: Partial<AutomationConfig>) => void;

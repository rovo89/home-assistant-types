...
import { DataEntryFlowStep, DataEntryFlowStepAbort, DataEntryFlowStepCreateEntry, DataEntryFlowStepExternal, DataEntryFlowStepForm, DataEntryFlowStepMenu, DataEntryFlowStepProgress, FlowType } from "../../data/data_entry_flow";
...
export interface FlowConfig {
    ...
    renderAbortDescription(hass: HomeAssistant, step: DataEntryFlowStepAbort): TemplateResult | "";
    ...
    renderShowFormStepFieldLabel(hass: HomeAssistant, step: DataEntryFlowStepForm, field: HaFormSchema): string;
    renderShowFormStepFieldHelper(hass: HomeAssistant, step: DataEntryFlowStepForm, field: HaFormSchema): TemplateResult | string;
...
export type LoadingReason = "loading_handlers" | "loading_flow" | "loading_step" | "loading_devices_areas";
